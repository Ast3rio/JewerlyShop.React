...
const ContactsForm = (props) => {
    ...
    return (
        <form onSubmit={props.handleSubmit}>
            <Field className={s.form_styles} label={"Имя"} validate={[required, maxLength40, minLength5]} name={"name"} type={"text"} component={Input} />
            <Field className={s.form_styles} label={"E-mail"} validate={[required, maxLength40, minLength5]} type={"text"} name={"email"} component={Input} />
